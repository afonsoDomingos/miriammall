  ...
  return (
    <div className="bg-slate-50/50 p-4 sm:p-6 rounded-xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 sm:gap-8">
        {/* SVG Map (Left 3 cols) */}
        <div className="lg:col-span-3 bg-white p-3 sm:p-4 rounded-lg border border-primary/5 flex flex-col items-center justify-center relative min-h-[280px] sm:min-h-[400px]">
          <h3 className="text-center font-serif text-base sm:text-lg text-primary mb-3 sm:mb-4 flex items-center justify-center gap-1.5">
            <Palmtree className="w-4 h-4 sm:w-5 sm:h-5 text-green" /> Planta Interativa - Piso {selectedFloor}
          </h3>

          {/* Mobile scroll hint */}
          <p className="text-[10px] text-primary/40 mb-2 flex items-center gap-1 sm:hidden">
            <Info className="w-3 h-3" /> Deslize para ver a planta completa
          </p>

          <div className="w-full overflow-x-auto max-w-full -mx-1 px-1">
            <svg
              viewBox="0 0 800 300"
              className="w-full min-w-[500px] sm:min-w-[600px] h-auto select-none"
            >
